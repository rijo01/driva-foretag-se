---
title: "Avveckla aktiebolag 2026 – likvidation, fusion & kostnad"
description: "Avveckla ditt AB rätt 2026: jämför frivillig likvidation, fusion, snabbavveckling och konkurs – med aktuella avgifter, tidsplan och skatteregler steg för steg."
category: "juridik"
type: "pillar"
...
readTime: "10 min"
tags: ["avveckla aktiebolag", "likvidation", "fusion", "snabbavveckling", "bolagsverket", "konkurs"]
...
Det vanligaste sättet att avveckla ett solvent aktiebolag är frivillig likvidation enligt 25 kap. aktiebolagslagen (2005:551). Beslutet fattas av bolagsstämman och innebär att en likvidator utses som tar över styrelsens och VD:s uppgifter. Läs hela genomgången i vår guide om [frivillig likvidation av aktiebolag](/juridik/likvidation-aktiebolag).

### Snabbavveckling (försäljning)

Snabbavveckling innebär att du säljer aktiebolaget till ett företag som är specialiserat på att avveckla bolag. Du får köpeskillingen utbetald direkt och slipper vänta ut den långa likvidationsprocessen – köparen tar över och genomför likvidationen. Observera att det alltså **inte** går att "avregistrera" ett aktiebolag direkt hos Bolagsverket; ett AB måste alltid avvecklas genom likvidation, fusion eller konkurs.

### Fusion

Ett aktiebolag kan avvecklas genom att fusioneras med ett annat bolag. Det övertagande bolaget tar då över alla tillgångar och skulder och det överlåtande bolaget upplöses utan likvidation. Fusioner regleras i 23 kap. ABL – se vår fördjupning om [fusion av aktiebolag](/juridik/fusion-aktiebolag).

### Tvångslikvidation

I vissa fall kan Bolagsverket eller tingsrätten besluta om tvångslikvidation, exempelvis om bolaget inte skickar in årsredovisning, saknar behörig styrelse eller om bolagets eget kapital är förbrukat. Läs mer i vår guide om [tvångslikvidation av aktiebolag](/juridik/tvangslikvidation-aktiebolag).
...
Avgiften för kallelse på okända borgenärer är 1 000 kr (2026). Under den sexmånadersperiod som kallelsen löper kan likvidatorn inte göra någon slutlig fördelning av bolagets tillgångar.
...
## Snabbavveckling – sälj bolaget istället för att likvidera

En viktig sak att förstå är att ett aktiebolag **inte** kan "avregistreras" direkt hos Bolagsverket bara för att verksamheten upphört. Ett AB måste alltid avvecklas formellt genom likvidation, fusion eller konkurs. Det räcker alltså inte att sluta använda bolaget.

Snabbavveckling är ett kommersiellt alternativ där du **säljer hela aktiebolaget** till ett företag som specialiserat sig på att avveckla bolag. Köparen tar över bolaget och genomför den lagstadgade likvidationen, medan du som säljare får köpeskillingen utbetald i förskott.

### Så går snabbavveckling till

1. Du tar kontakt med en avvecklingsfirma som värderar bolagets nettotillgångar
2. Aktierna i bolaget säljs till avvecklingsfirman, ofta mot ett avdrag (arvode) från nettoförmögenheten
3. Du får betalt direkt – vanligtvis inom någon eller några veckor
4. Köparen ansvarar därefter för hela likvidationsprocessen, som ändå tar minst sju månader

### Fördelar och risker

Fördelen är att du får ut pengarna snabbt och slipper administrationen under likvidationstiden. Beskattningen sker som en vanlig aktieförsäljning (kapitalvinst, eller enligt [3:12-reglerna](/skatt/3-12-reglerna) för kvalificerade andelar).

Risken är att seriösa och oseriösa aktörer förekommer. Välj en etablerad avvecklingsfirma och säkerställ att likvidationen verkligen genomförs – du som tidigare ägare vill inte riskera kvarstående ansvar om köparen inte sköter avvecklingen korrekt.
