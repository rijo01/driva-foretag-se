...
- **Gränsbelopp (kapitalinkomst)** – Den del av vinsten som ryms inom det sparade utdelningsutrymmet beskattas med 20 procent. Sedan beskattningsår 2026 beräknas gränsbeloppet enligt en enda regel: ett grundbelopp på fyra inkomstbasbelopp (322 400 kr för 2026) plus ett lönebaserat utrymme och ränta på omkostnadsbeloppet, som adderas.
