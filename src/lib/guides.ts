...
export const guides: Guide[] = [
  ...
  { slug: "cafe", name: "Café", tagline: "Livsmedelsregistrering, läge och marginaler.", available: true },
  ...
  { slug: "frisorsalong", name: "Frisörsalong", tagline: "Stol-hyra eller anställning, kassaregister och kunder.", available: true },
  ...
  { slug: "fastighetsbolag", name: "Fastighetsbolag", tagline: "Bolagsstruktur, finansiering och förvaltning.", available: true },
  { slug: "webbyra", name: "Webbyrå", tagline: "Paketering, retainers och återkommande kunder.", available: true },
  { slug: "skonhetssalong", name: "Skönhetssalong", tagline: "Hygienlokal, anmälan och behandlingsutbud.", available: true },
  { slug: "personlig-tranare", name: "Personlig tränare & Gym", tagline: "Lokal, försäkring och att bygga kundstock.", available: true },
  { slug: "maleri", name: "Måleri", tagline: "ROT-avdrag, offert och säsongsplanering.", available: true },
  { slug: "tradgard", name: "Trädgård & Landskap", tagline: "RUT/ROT, maskinpark och säsongens ekonomi.", available: true },
  { slug: "fotograf", name: "Fotograf", tagline: "Bildrättigheter, paketpris och portföljbygge.", available: true },
  { slug: "event", name: "Event & Bröllop", tagline: "Avtal, försäkring och prissättning av uppdrag.", available: true },
];
